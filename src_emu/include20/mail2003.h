 ...
 *                       All Rights Reserved
 *
 * Model   : Hopen E-mail System Program (Email-2003)
 *
 * Filename: mail2003.h   
 *
...
/*************************************************************************\
*
*	程序名称：Hopen Email-2003 (main program)
*
*	模块名称：mail agent management
*
*	程序功能：实现发送、接收、删除、检索电子邮件。
*
*	文件名称：mail2003.h
*
*	作者姓名：周林涛
...
/* 定义信件标记 *//* Revision Q(3) */
#define F_RECENT			0x0001
#define F_NEW				0x0002

/* 定义邮件部件列表长度 */
#define PARTLIST_LEN		32

/* 定义部件类型 */
#define PART_TEXT			1
#define PART_ATTCHMENT		2
#define PART_MESSAGE		3
...
/* 发件箱类函数 */
int		MAIL_CreateOutQueue(HWND hwnd, int msg, ACCOUNT* account);
