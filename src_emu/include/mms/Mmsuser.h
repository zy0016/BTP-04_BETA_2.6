...
#define MMS_ALWREPORT	9	/* 是否允许投递报告	*/

#define MMS_LOWPRTCL	10	/* MMS的底层协议	*/

/* 所使用的协议, MMS_LOWPRTCL的值 */
#define WSP_PROTOCOL	0
...
int MMS_IOCtrl(int Command, int *argp, int Length);
