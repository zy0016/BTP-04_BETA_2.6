...
#ifdef __MMU__
#define io_p2v(x)	( (((unsigned long)(x)) | 0xbe000000) ^ (~(((unsigned long)(x)) >> 1) & 0x06000000) )
#define io_v2p(x)	( (((unsigned long)(x)) & 0x41ffffff) ^ ( (((unsigned long)(x)) & 0x06000000) << 1) )
#else
...
#define PXA_DMAC_BASE		IO_ADDRESS(0x40000000)  // Direct Memory Access Controller registers
#define PXA_FFUART_BASE		IO_ADDRESS(0x40100000)  // Full Function UART
#define PXA_BTUART_BASE		IO_ADDRESS(0x40200000)  // Bluetooth UART
#define PXA_I2C_BASE 		IO_ADDRESS(0x40300000)	// Inter-Integrated Circuit (I2C) bus interface unit
#define PXA_I2S_BASE		IO_ADDRESS(0x40400000)  // Inter-Integrated Circuit Sound (I2S)
#define PXA_AC97_BASE		IO_ADDRESS(0x40500000)  // AC97 Controller Unit (ACUNIT)
#define PXA_UDC_BASE		IO_ADDRESS(0x40600000)  // Universal Serial Bus Device Controller
#define PXA_STUART_BASE		IO_ADDRESS(0x40700000)  // Standard UART
#define PXA_ICP_BASE		IO_ADDRESS(0x40800000)  // Fast Infrared Communications Port
#define PXA_RTC_BASE		IO_ADDRESS(0x40900000)  // realtime clock
#define PXA_OST_BASE		IO_ADDRESS(0x40A00000)  // OS Timers
#define PXA_PWM0_BASE		IO_ADDRESS(0x40B00000)  // pulse width modulator 0
#define PXA_PWM1_BASE		IO_ADDRESS(0x40C00000)  // pulse width modulator 1
#define PXA_IC_BASE 		IO_ADDRESS(0x40D00000)	// interrupt controller registers
#define PXA_GPIO_BASE		IO_ADDRESS(0x40E00000)	// gpio
#define PXA_PMRC_BASE		IO_ADDRESS(0x40F00000)	// Power Manager and Reset Control
#define PXA_SSP_BASE 		IO_ADDRESS(0x41000000)	// Serial Port Controller¡¯s (SSPC)
#define PXA_MMC_BASE		IO_ADDRESS(0x41100000)  // MultiMediaCard (MMC) controller
#define PXA_CLKM_BASE		IO_ADDRESS(0x41300000)  // Clocks Manager
#define PXA_NSSP_BASE		IO_ADDRESS(0x41400000)  // Network Synchronous Serial Protocol (NSSP)
#define PXA_ASSP_BASE		IO_ADDRESS(0x41500000)  // Audio Synchronous Serial Protocol (ASSP)
#define PXA_HWUART_BASE		IO_ADDRESS(0x41600000)  // Hardware UART (HWUART) port.
#define PXA_LCDC_BASE 		IO_ADDRESS(0x44000000)	// LCD controller registers
#define PXA_MC_BASE 		IO_ADDRESS(0x48000000)	// Memory Configuration Registers

/* interrupt numbers */
#define PXA_INT_RESERVED0	0
#define PXA_INT_RESERVED1	1
#define PXA_INT_RESERVED2	2
#define PXA_INT_RESERVED3	3
#define PXA_INT_RESERVED4	4
#define PXA_INT_RESERVED5	5
#define PXA_INT_RESERVED6	6
#define PXA_INT_HWUART		7
#define PXA_INT_GPIO0		8
#define PXA_INT_GPIO1		9
#define PXA_INT_GPIO_2_80	10
#define PXA_INT_UDC			11
#define PXA_INT_PMU			12
#define PXA_INT_I2S			13
#define PXA_INT_AC97		14
#define PXA_INT_ASSP		15
#define PXA_INT_NSSP		16
#define PXA_INT_LCDC		17
#define PXA_INT_I2C			18
#define PXA_INT_ICP			19
#define PXA_INT_STUART		20
#define PXA_INT_BTUART		21
#define PXA_INT_FFUART		22
#define PXA_INT_MMC			23
#define PXA_INT_SSP			24
#define PXA_INT_DMAC		25
#define PXA_INT_OST0		26
#define PXA_INT_OST1		27
#define PXA_INT_OST2		28
#define PXA_INT_OST3		29
#define PXA_INT_RTC			30
#define PXA_INT_ALARM		31
...
#define XSMCR_LOOP	(1 << 4)	/**/ 
#define XSMCR_OUT2	(1 << 3)	/* force MSR_DCD in loopback mode */
#define XSMCR_OUT1	(1 << 2)	/* force MSR_RI in loopback mode */
#define XSMCR_RTS		(1 << 1)	/* Request to Send */
#define XSMCR_DTR		(1 << 0)	/* Data Terminal Ready */

#define XSMSR_DCD		(1 << 7)	/* Data Carrier Detect */
#define XSMSR_RI		(1 << 6)	/* Ring Indicator */
#define XSMSR_DSR		(1 << 5)	/* Data Set Ready */
#define XSMSR_CTS		(1 << 4)	/* Clear To Send */
#define XSMSR_DDCD	(1 << 3)	/* Delta Data Carrier Detect */
#define XSMSR_TERI	(1 << 2)	/* Trailing Edge Ring Indicator */
#define XSMSR_DDSR	(1 << 1)	/* Delta Data Set Ready */
#define XSMSR_DCTS	(1 << 0)	/* Delta Clear To Send */
...
#define UFNRH_FNMSB_SHIFT			0
#define UFNRH_FNMSB_MASK			( 0x3 << UFNRH_FNMSB_SHIFT )
                                                        // Used to read the 3 most significant bits of the
                                                        // 11-bit frame number	associated with last SOF
#define UFNRH_SIM					( 0x1 << 6 )	// SOF(start of frame) interrupt disabled
#define UFNRH_SIR					( 0x1 << 7 )	// SOF(start of frame) interrupt received												


// UDC Frame Number Low Register (UFNLR)
#define UFNRL_FNMSB_SHIFT			0
#define UFNRL_FNMSB_MASK			( 0xff << UDC_UFNRL_FNMSB_SHIFT )
...
#define OSMR(x)		__REG2(0x40A00000, (x) << 2)
...
extern void pxa_gpio_config(int gpio_mode);

static __inline__ void pxa_clk_enable(unsigned clk)
{
	CKEN |= clk;
}

static __inline__ void pxa_clk_disable(unsigned clk)
{
	CKEN &= ~clk;
}
