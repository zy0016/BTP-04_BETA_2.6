...
// _DEBUG project automatically define macro DEBUG_OBJECT
#ifdef _DEBUG
#ifndef DEBUG_OBJECT
#define DEBUG_OBJECT
#endif
...
#if defined(NO_DEBUG_MEMORY) && defined(NO_DEBUG_FS) && defined(NO_DEBUG_WINDOW) && defined(NO_DEBUG_IMAGE)
#ifdef DEBUG_OBJECT
#undef DEBUG_OBJECT
#endif
#endif
...
#define calloc(nmemb, size)        DBG_calloc(nmemb, size, __MODULE__, __FILE__, __LINE__)
...
#define creat(pathname, mode)	\
	DBG_creat(pathname, mode, __MODULE__, __FILE__, __LINE__)
#define close(fd)		\
	DBG_close(fd,__MODULE__, __FILE__, __LINE__)
...
#define opendir(dirname)	DBG_opendir(dirname, __MODULE__, __FILE__, __LINE__)
#define closedir(dir)		DBG_closedir(dir, __MODULE__, __FILE__, __LINE__)
...
#define SetTimer(hWnd, uIDEvent, uElapse, pTimerFunc)	\
	DBG_SetTimer(hWnd, uIDEvent, uElapse, pTimerFunc,__MODULE__, __FILE__, __LINE__)
#define KillTimer(hWnd, uIDEvent)	\
	DBG_KillTimer(hWnd, uIDEvent,__MODULE__, __FILE__, __LINE__)
