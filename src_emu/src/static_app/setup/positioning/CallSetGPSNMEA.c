...
static char * pClassName = "SetGPSNMEAClass";
...
BOOL CallSetGPSNMEA(HWND hParentWnd, int iGPSIndex)
{
    WNDCLASS    wc;
    RECT rClient;
    ...
    SetWindowText(hFrameWin, ML("NMEA output"));
    SetFocus(hWndApp);
...
static BOOL CreateControl (HWND hWnd, HWND *hList)
{
    ...
    * hList = CreateWindow("LISTBOX", 0, 
    ...
    SendMessage(* hList, LB_ADDSTRING, 0, (LPARAM)ML("4800 bps"));
