 ...
 */
void PNGAPI
png_read_image(png_structp png_ptr, png_infop info_ptr, png_bytepp image)
{
   png_uint_32 i,image_height, k;
   int pass, j, nChannel, ulRowBytes;
   png_bytepp rp, rpDst;
   png_bytep pvBits, pSrc, pDest;
   ...
   pvBits = (png_bytep)malloc(ulRowBytes);
                           ...
                           voidp params)
{
   ...
   png_read_image(png_ptr, info_ptr, info_ptr->row_pointers);
