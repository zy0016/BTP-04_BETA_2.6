 ...
 *
 * Purpose  : Implement the dibitblt functions.
 *            
\**************************************************************************/
...
#elif (LDD_MODE == DDM_RGB24_RGB || LDD_MODE == DDM_RGB24_BGR)
        {
                       ...
                       int x, int y, PGRAPHPARAM pGraphParam)
{
    ...
    else
    {
        ...
        dwRedMask   = pRGBMask[0];
        dwGreenMask = pRGBMask[1];
        dwBlueMask  = pRGBMask[2];
...
#if (LDD_MODE == DDM_RGB24_BGR || LDD_MODE == DDM_RGB18_BGR)
    if (bk_mode == BM_OPAQUE)
    {
        COPYLINESTRUCT p;
...
#if (LDD_MODE == DDM_RGB32_BGR0 || LDD_MODE == DDM_RGB18_BGR0 ||    \
