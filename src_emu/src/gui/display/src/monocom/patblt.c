 ...
 *
 * Purpose  : Implement the patblt functions.
 *            
\**************************************************************************/
...
//        RectFill(pDev, pGraphParam, &rc, 0);
    ...
    {        
        FillSolidRect(pDev, &rc, pBrush->fgcolor, rop);
/*
...
*/
    ...
    else if(pBrush->style == BS_HATCHED)
    {
        ...
        MonoPatBlt(pDev, rc.x1, rc.y1, rc.x2 - 1, 
            ...
            pGraphParam->bk_color, pBrush->fgcolor);
    }   
                      ...
                      GRAPHPARAM* pGraphParam, PENSTYLE penstyle)
{
    ...
    */
    ...
    pencolor = (pGraphParam->pBrush->fgcolor == 0) ? 0x00 : 0xFFFFFFFFL;
                      ...
                      PGRAPHPARAM pGraphParam)
{
    ...
    {
            DrawSolidHLine(pDev, x1, x2, y,
                rop, pGraphParam->pBrush->fgcolor);
    }
