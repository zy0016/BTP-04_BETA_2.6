 ...
 *
 * Purpose  : Logical Display Driver. Implement some commmon interfaces.
 *            
\**************************************************************************/
...
/* comnfunc.h define the common functions in the display driver */
#include "dispcomn.h"
...
* Remarks	   
**********************************************************************/
PDISPLAYDRVINFO EnableMonoDisplayDev(struct DisplayDrvInfo * pDisplay)
{
    if (pDisplay != NULL)
