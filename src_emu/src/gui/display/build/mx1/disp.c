...
BOOL PDD_GetDisplayMode(int dev, POS_DISPLAYMODE pDisplayMode)
{
 ...
 //   ioctl(fd, LCD_IOC_GETINFO, (char*)&lcdinfo);
...
//	TRACE("***** vramaddr = 0x%08XL \r\n", lcdinfo.addr);
    ...
    pDisplayMode->dsp_planes = 1;
    pDisplayMode->dsp_scanline_bytes = 176*2; //(fvs.xres * fvs.bits_per_pixel) / 8;
    pDisplayMode->dsp_screen_buffer = 0xf4100000; //(void*)lcdinfo.addr;// 0x2F0000;
    pDisplayMode->dsp_updatescreen = LCD_NOLCDC;

//	{
//		int i;
//		for(i=0;i<176*220;i++)
//			*(unsigned char*)(0xf4100000+i)=0x00;
//		for(i=176*220;i<176*220*2;i++)
//			*(unsigned char*)(0xf4100000+i)=0xFF;
