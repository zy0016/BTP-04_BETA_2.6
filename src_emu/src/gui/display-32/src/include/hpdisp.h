...
typedef struct PhysDev {
    ...
    signed char    bUpdate;    /* update screen flags */
    int8    device_no;  /* the device no */
    int8    bAccelerate;/* Hardware accelerate */
    int8    state;      /* state of the device: suspend... */
...
#define DEV_STATE_RUN       0
#define DEV_STATE_SUSPEND   1
...
#define Color24To15(c24)    ((((c24) & 0xf80000L) >> 19) \
                         |   (((c24) & 0x00f800L) >>  6) \
                         |   (((c24) & 0x0000f8L) <<  7))
#define Color16To15(c16)    ((((c16) & 0xffc0) >> 1) | ((c16) & 0x001f))
...
#define Color24To16(c24)    ((((c24) & 0xf80000L) >> 19) \
                         |   (((c24) & 0x00fc00L) >>  5) \
                         |   (((c24) & 0x0000f8L) <<  8) )
#define Color15To16(c15)    ((((c15) & 0xefc0) << 1) | ((c15) & 0x003f))
...
/* 00000000000000rrrrrrggggggbbbbbb*/
#define REALIZECOLOR32_0x0R6G6B6(r, g, b) \
((((r) << 10) & 0x3f000) | (((g) << 4) & 0x00fc0) | ((b) >> 2))

/* bbbbbbggggggrrrrrr00000000000000*/
#define REALIZECOLOR32_0xB6G6R60(r, g, b) \
((((b) << 24) & 0xfc000000) | (((g) << 18) & 0x03f00000) | (((r) << 10) & 000fc000))
...
/* convert 32 to 0xBGR (RGB macro format) */
#define REALIZECOLOR32TO24_0x0RGB(s) \
    ((((s) & 0xff0000) >> 16) | (((s) & 0x00ff00)) | (((s) & 0x0000ff) << 16))
#define REALIZECOLOR32TO24_0xBGR0(s) ((s) >> 8)

#define REALIZECOLOR32TO24_0x0R6G6B6(s) \
((((s) & 0x3F000) >> 10) | (((s) & 0x30000) >> 16)) |   \
((((s) & 0x00FC0) <<  4) | (((s) & 0x00C00) >>  2)) |   \
((((s) & 0x0003F) << 26) | (((s) & 0x00030) << 20))
...
/* 0xAR6G6B6 the highest bits is overlay */
#define GETABYTE32_AR6G6B6(c) (((c) & 0x20000) >> 17)
#define GETRBYTE32_AR6G6B6(c) ((((c) & 0x3F000) >> 10) | (((c) & 0x30000) >> 16))
#define GETGBYTE32_AR6G6B6(c) ((((c) & 0x00FC0) >>  4) | (((c) & 0x00C00) >> 10))
#define GETBBYTE32_AR6G6B6(c) ((((c) & 0x0003F) <<  2) | (((c) & 0x00030) >>  4))
...
#define Color24To1(c24) (REALIZECOLOR1((c24) & 0xFF, ((c24) >> 8) & 0xFF, ((c24) >> 16) & 0xFF))
...
#elif ((LDD_MODE == DDM_RGB18_B6G6R60) && (!DISP_BIG_ENDIAN))
#define GETRBYTE        GETRBYTE32_AR6G6B6
#define GETGBYTE        GETGBYTE32_AR6G6B6
#define GETBBYTE        GETBBYTE32_AR6G6B6
#define	GETPIXEL        GET32_DW
#define	PUTPIXEL        Put32_DWEx
//#define REALIZECOLOR    REALIZECOLOR32_0x0R6G6B6
//#define	PUTPIXEL        Put32_DWEx
#define REALIZECOLOR    REALIZECOLOR32_0x0R6G6B6Ex
#undef REALIZECOLOR32TO24 
#define REALIZECOLOR32TO24 REALIZECOLOR32TO24_0x0R6G6B6
...
/* a的取值范围是15*255, t=a/15 */
#define INT8_15DIVIDED(a, t)    \
(((t) = (a) + 8), t = ((((((t) >> 4) + (t)) >> 4) + (t)) >> 4))

/* a的取值范围是31*255, t=a/31 */
#define INT8_31DIVIDED(a, t)    \
(((t) = (a) + 16), t = ((((((t) >> 5) + (t)) >> 5))))

/* a的取值范围是63*255, t=a/63 */
#define INT8_63DIVIDED(a, t)    \
(((t) = (a) + 32), t = (((t) >> 6) + (t)) >> 6)

/* a的取值范围是255*255, t=a/255 */
