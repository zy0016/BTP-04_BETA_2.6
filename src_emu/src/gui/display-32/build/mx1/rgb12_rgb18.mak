...
display.ms : $(DISP_DISPLAY_DIR)\display.c
	$(GCC33) $(GCC33_FLAG) $(SPEC_DISPLAY_FLAG) $(DISP_DISPLAY_DIR)\$*.c
	$(EXT33) $(EXT33_FLAG) $*.ps
display.o : display.ms

## rgb12.c
rgb12.ms : $(DISP_RGB_DIR)\rgb12.c
	$(GCC33) $(GCC33_FLAG) $(SPEC_RGB_FLAG) $(DISP_RGB_DIR)\$*.c
	$(EXT33) $(EXT33_FLAG) $*.ps
rgb12.o : rgb12.ms

## rgb18.c
rgb18.ms : $(DISP_RGB_DIR)\rgb18.c
	$(GCC33) $(GCC33_FLAG) $(SPEC_RGB_FLAG) $(DISP_RGB_DIR)\$*.c
	$(EXT33) $(EXT33_FLAG) $*.ps
rgb18.o : rgb18.ms
